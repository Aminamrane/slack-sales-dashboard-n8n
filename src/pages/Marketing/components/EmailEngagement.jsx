...
const EMAIL_KIND_LABELS = {
  ...
  // Cohorte du 7 septembre (ambulances) : séquence dédiée côté landing.
  email_sep07_why: 'Vous ne serez probablement pas là',
  email_sep07_discover: 'Ce webinaire ne vous apprendra peut-être rien',
  email_sep07_holding: 'Ambulances : une holding a-t-elle du sens ?',
  email_sep07_comptable: 'Redevance de marque · simulateur',
  email_sep07_pertes: 'Combien perdez-vous chaque année ?',
  email_sep07_j7: 'J-7 · dernière ligne droite',
  email_sep07_j3: 'J-3 · confirmez votre présence',
  email_sep07_j1: 'J-1 · demain',
  email_sep07_morning: 'Matin J',
  email_sep07_h1: 'H-1',
  email_sep07_live: 'On est en live',
  email_sep07_live15: 'Live +15 min',
  // Cohorte du 21 septembre (TPE/PME) : séquence dédiée côté landing.
  email_sep21_invitation: 'Invitation (.ics)',
  email_sep21_why: 'Vous ne serez probablement pas là',
  email_sep21_discover: 'Ce que vous allez découvrir',
  email_sep21_holding: 'TPE/PME : une holding a-t-elle du sens ?',
  email_sep21_simulateur: 'Redevance de marque · simulateur',
  email_sep21_pertes: 'Combien perdez-vous chaque année ?',
  email_sep21_j7: 'J-7 · dernière ligne droite',
  email_sep21_j3: 'J-3 · confirmez votre présence',
  email_sep21_j1: 'J-1 · demain',
  email_sep21_morning: 'Matin J',
  email_sep21_h1: 'H-1',
  email_sep21_live: 'On est en live',
  email_sep21_live15: 'Live +15 min',
  // Relances post-live du 21 septembre (normalement dans « Séquences
  // post-webinaire » ; étiquetées ici au cas où la landing les remonte).
  email_post21_j1: 'Post-live J+1',
  email_post21_j2: 'Post-live J+2',
  email_post21_j3: 'Post-live J+3',
  email_post21_j4: 'Post-live J+4',
};

// Ordre chronologique d'envoi. Une cohorte ne remonte que ses propres kinds,
// l'ordre entre cohortes n'a donc pas d'importance.
const EMAIL_KIND_ORDER = [
  ...
  // 7 septembre
  'email_sep07_why',
  'email_sep07_discover',
  'email_sep07_holding',
  'email_sep07_comptable',
  'email_sep07_pertes',
  'email_sep07_j7',
  'email_sep07_j3',
  'email_sep07_j1',
  ...
  'email_sep07_live15',
  // 21 septembre
  'email_sep21_invitation',
  'email_sep21_why',
  'email_sep21_discover',
  'email_sep21_holding',
  'email_sep21_simulateur',
  'email_sep21_pertes',
  'email_sep21_j7',
  'email_sep21_j3',
  'email_sep21_j1',
