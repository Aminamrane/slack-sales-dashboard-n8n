...
// jamais), exactement comme Variables / Qualité des leads / etc. Avant, le
// tab "Congés" sautait vers /equipe (page nue sans sidebar) -> on quittait
// le dashboard. La page standalone /equipe reste disponible et inchangée.
//
// Données RH (absences équipe) -> accès restreint admin / ceo / hr, comme
// CeoVariablesView (la section "Humain" n'est visible que par ces rôles).
