          ...
          <>
            ...
            <div style={{
              ...
              >
                ...
                {(apiClient.getUser()?.role === 'admin' || apiClient.getUser()?.role === 'ceo' || apiClient.getUser()?.role === 'marketing') && (
                  <button
                ...
                {(apiClient.getUser()?.role === 'admin' || apiClient.getUser()?.role === 'optilex' || apiClient.getUser()?.role === 'finance_team') && (
                  <button
                    onClick={() => navigate("/optilex-board")}
                    style={{
                      display: 'flex', alignItems: 'center', gap: '8px', padding: '10px 12px',
                      borderRadius: '8px', border: 'none', background: 'transparent',
                      color: darkMode ? '#f5f5f7' : '#1d1d1f', fontSize: '14px', fontWeight: 500,
                ...
                {(apiClient.getUser()?.role === 'admin' || apiClient.getUser()?.role === 'ceo' || apiClient.getUser()?.role === 'hr') && (
                  <button
